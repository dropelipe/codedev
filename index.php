            ...
            <div class="interface"><!-- interface -->
                ...
                <div class="flex"><!-- flex -->
                    <div class="cursos-cards"><!--cursos-cards-html-->
                        ...
                        <img width="60" height="60" src="https://img.icons8.com/color/48/html-5--v1.png" alt="html-5--v1"/></a>
                        <h3>HTML</h3>
                    ...
                    <div class="cursos-cards"><!-- cursos-cards-css -->
                        ...
                        <img width="60" height="60" src="https://img.icons8.com/color/48/css3.png" alt="css3"/></a>
                        <h3>CSS</h3>
                    ...
                    <div class="cursos-cards"><!--cursos-cards-java-->
                        <a href="pagcurso-HTML.php">
                        <img width="60" height="60" src="https://img.icons8.com/color/48/javascript--v1.png" alt="javascript--v1"/></a>
                        <h3>JavaScript</h3>
